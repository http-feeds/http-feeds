...
`timeout`      | Number      | Optional  | Set this, when long-polling should be used and is supported by the server. Max waiting time in milliseconds for long-polling, after which the server must send a response.
